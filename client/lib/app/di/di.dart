...
import '../../features/auth/data/data_source/remote_datasource/remote_datasource.dart';
...
import '../../features/auth/domain/use_case/signup_use_case.dart';
...
import '../../features/cart/domain/usecases/fetch_cart.dart';
...
import '../../features/products/domain/usecases/fetch_reviews.dart';
import '../../features/products/domain/usecases/write_review.dart';
import '../../features/products/presentation/view_model/products/products_cubit.dart';
import '../../features/products/presentation/view_model/reviews/reviews_cubit.dart';
...
import '../shared_prefs/onboarding_shared_prefs.dart';
...
Future<void> _initSharedPreferences() async {
  ...
  getIt
      .registerLazySingleton<TokenSharedPrefs>(() => TokenSharedPrefs(getIt()));
  getIt.registerLazySingleton<OnboardingSharedPrefs>(
      () => OnboardingSharedPrefs(getIt()));
}
...
_initSignupDependencies() async {
  ...
  getIt.registerLazySingleton<IAuthRepository>(
      () => AuthRemoteRepository(getIt(), getIt()));
...
_initCartDependencies() async {
  getIt.registerFactory<CartRemoteDatasource>(
