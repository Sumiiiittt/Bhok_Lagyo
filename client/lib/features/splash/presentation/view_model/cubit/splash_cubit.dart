...
class SplashCubit extends Cubit<void> {
  SplashCubit(this._tokenSharedPrefs, this._homeCubit, this._loginBloc, this._onboardingSharedPrefs) : super(null);
  ...
  void goToLogin(BuildContext context) {
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => BlocProvider.value(value: _loginBloc, child: LoginPage())));
  }

  void goToHome(BuildContext context) {
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => BlocProvider.value(value: _homeCubit, child: DashboardPageView())));
  }
